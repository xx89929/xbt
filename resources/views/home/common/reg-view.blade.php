            ...
            <form id="usr-reg" class="form-horizontal text-center" method="POST" action="{{route('register')}}">
                ...
                <div class="form-group">
                    <div class="input-group v-member-input">
                        ...
                        <input id="userPhoneSend" name="username" type="text" class="form-control" placeholder="输入手机号" value="{{ old('username') }}" required autofocus>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group v-member-input">
                        <div class="input-group-addon v-member-label"><i class="fa fa-lock"></i></div>
                        <input name="password" type="password" class="form-control" placeholder="设置登陆密码">
                    </div>
                </div>
                {{--<div class="form-group">--}}
                    {{--<div class="input-group v-member-input">--}}
                ...
                {{--<div class="form-group">--}}
                    {{--<div class="input-group v-member-input">--}}
                        ...
                        {{--<input  name="phone" type="text" class="form-control" placeholder="手机号：可用于登陆和找回密码" value="{{ old('phone') }}" required autofocus>--}}
                    {{--</div>--}}
                {{--</div>--}}
