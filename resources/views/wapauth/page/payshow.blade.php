                        ...
                        <ul>
                            <li class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-subtitle">{{$res['doctor']->doc_group_sns->title}}</div>
                                </div>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-subtitle">
                                        <div class="clearfix row no-gutter ps-num-controller">
                                            <button class="pull-left" id="ps-num-controller-dec">-</button>
                                            <div class="pull-left col-20 item-input">
                                                <input id="ps-num-val" type="text"  value="1">
                                            </div>
                                            <button class="pull-left" id="ps-num-controller-add">+</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="card-content">
                    ...
                    <div class="content-block">
                        <div class="row ps-submit-box">
                            ...
                            <div class="col-50"><a href="#" class="button">立即购买</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        var price = "{{number_format($res['product']->price,2)}}";
        totalNum(price,1);
